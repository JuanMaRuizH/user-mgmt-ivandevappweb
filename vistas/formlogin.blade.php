            ...
            <div class="panel-body mt-3">
                <form class="form-horizontal validate" method="POST" action="index.php" id='formlogin'>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="inputNombre" type="text" value="{{(isset($nombre) ) ? $nombre : "" }}" class="{{ (isset($nombre) && !$nombre) ? "
                                form-control is-invalid col-sm-10 " : "form-control col-sm-10 " }}" id="inputNombre" placeholder="Nombre"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="password" value="{{ (isset($clave) ) ? $clave : "" }}" class="{{ (isset($clave) && !$clave) ? " form-control
                                is-invalid col-sm-10 " : "form-control col-sm-10 " }}" id="inputPassword" placeholder="Password"
                                name="clave" required required pattern="{{ $REGEXP_CLAVE }}" title="La clave tiene entre 4 y 8 caracteres e incluye al menos un número">
